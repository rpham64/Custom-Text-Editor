...
public class EfficientDocument extends Document {
	...
	private void processText()
	{
		...
		// Contains words and punctuation from the document text
	...
	public int getNumSentences() {
		...
		// split returns an array of strings around matches of the given regex
		sentences = getTokens(regex);
